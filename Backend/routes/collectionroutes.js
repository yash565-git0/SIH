...
router.post("/",authenticateAppToken, collectionValidation, CollectionController.createCollectionEvent);
...
router.put("/:eventId",authenticateAppToken, param("eventId").isMongoId(), CollectionController.updateCollectionEvent); 
